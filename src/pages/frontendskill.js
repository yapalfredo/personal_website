...
export default function FrontEndSkills() {
  return (
    <div className="text-center shadow-2xl p-4 sm:p-5 md:p-6 lg:p-8 xl:p-10 2xl:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 dark:from-slate-900 dark:via-blue-950 dark:to-slate-800 w-full h-full transition-all duration-500 hover:shadow-[0_25px_50px_-12px_rgba(59,130,246,0.4)] dark:hover:shadow-[0_25px_50px_-12px_rgba(59,130,246,0.5)] hover:scale-[1.02] hover:-translate-y-2 border border-blue-200/60 dark:border-blue-500/30 dark:shadow-blue-500/30 backdrop-blur-sm relative overflow-hidden group flex flex-col">
      <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-blue-100/20 to-transparent dark:from-blue-500/5 dark:via-blue-400/10 dark:to-transparent pointer-events-none group-hover:from-white/50 group-hover:via-blue-100/30 transition-all duration-500"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-blue-200/20 via-transparent to-transparent dark:from-blue-400/10 dark:via-transparent pointer-events-none"></div>
      <div className="relative z-10">
        <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold pb-3 sm:pb-4 md:pb-5 lg:pb-6 xl:pb-8 2xl:pb-10 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-300 dark:to-cyan-300 bg-clip-text text-transparent transition-all duration-300 tracking-tight drop-shadow-sm">
          Frontend
        </h3>
